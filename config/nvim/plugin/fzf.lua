...
vim.keymap.set("n", "<leader>fz", function() fzf_lua().zoxide() end, { silent = true, desc = "zoxide" })
vim.keymap.set("n", "<leader>ft", function() fzf_lua().treesitter() end, { silent = true, desc = "treesitter" })
vim.keymap.set("n", "<leader>fd", function() fzf_lua().diagnostics_workspace() end, { silent = true, desc = "diagnostics workspace" })
